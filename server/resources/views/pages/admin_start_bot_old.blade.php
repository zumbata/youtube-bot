@extends('layouts.default', ['title' => 'Start Bot'])
@section('content')
    ...
    <form action="/admin/bots" method="POST">
        ...
        <div id="for_old">
            ...
            <br><hr>
            <textarea rows="10" name="accounts"></textarea><br>
            <pre>
...
a123sdasd@gmail.com;asdasd;asd543@gmail.com;1
                ...
                <br><hr>
                <textarea rows="10" name="comments"></textarea><br>
                <pre>
...
this is third example comment
            ...
            <label>Proxies</label>
            <br><hr>
            <textarea rows="10" name="proxies"></textarea><br>
            <pre>
...
444.444.444.444:3131
            ...
            <br><hr>
            <textarea rows="10" name="keywords"></textarea><br>
            <pre>
...
this is third example keyword
            ...
            <br><hr>
            <input type="number" name="min_time">
            <br><br>
            <label>MAX watchtime</label>
            <br><hr>
            <input type="number" name="max_time">
            <br><br><br>
